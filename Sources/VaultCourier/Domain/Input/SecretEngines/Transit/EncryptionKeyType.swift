...
extension EncryptionKey {
    public enum KeyType: RawRepresentable, Codable, Sendable {
        case aes128_gcm96
        case aes256_gcm96
    ...
    public enum ImportedType: Sendable {
        case ciphertext(String)
        case publicKey(String)
    }

    public enum ExportedType: String, Sendable {
        case encryptionKey = "encryption-key"
        case signingKey = "signing-key"
        case hmacKey = "hmac-key"
        case publicKey = "public-key"
    }

    public enum KeyFormat: String, Sendable {
        case base64
        case raw
        case der
        case pem
