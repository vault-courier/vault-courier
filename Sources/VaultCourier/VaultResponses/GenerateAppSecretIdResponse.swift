...
extension GenerateAppSecretIdResponse {
    init?(component: Components.Schemas.AuthMethodResponse) {
        ...
        self.secretIdAccessor = data.secretIdAccessor
        self.secretIdTtl = data.secretIdTtl
        self.secretIdNumUses = data.secretIdNumUses
    }
}
